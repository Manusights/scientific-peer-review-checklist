...
- `review_template.md`
- `statistical_review_guidelines.md`
- `experimental_design_checklist.md`

## Who this is for

- Early-career reviewers who want a rigorous structure
- Authors doing internal pre-submission checks
- Teams standardizing manuscript quality control
